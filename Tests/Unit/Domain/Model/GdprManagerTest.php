...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager::class,
            ['dummy']
        );
    }
