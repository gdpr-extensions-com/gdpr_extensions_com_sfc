...
use GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\MapLocation;
...
class GdprManagerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     *
     * @var \GdprExtensionsCom\GdprExtensionsComSfc\Domain\Repository\GdprManagerRepository
     */
    ...
    public function listAction(): \Psr\Http\Message\ResponseInterface
    {
        ...
        $youtubeData = $this->gdprManagerRepository->findByExtension_key('gdpr_extensions_com_sfc')->toArray();
     ...
     * action show
     *
     * @param \GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $gdprManager
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function showAction(\GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * action create
     *
     * @param \GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $newGdprManager
     */
    public function createAction(\GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $newGdprManager)
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function editAction(\GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function updateAction(\GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $gdprManager) : \Psr\Http\Message\ResponseInterface
    {
        $locationsData = [];
     ...
     * @param \GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $gdprManager
     */
    public function deleteAction(\GdprExtensionsCom\GdprExtensionsComSfc\Domain\Model\GdprManager $gdprManager)
    {
    ...
    /**
     * @param \GdprExtensionsCom\GdprExtensionsComSfc\Domain\Repository\GdprManagerRepository $gdprManagerRepository
     */
    public function injectGdprManagerRepository(\GdprExtensionsCom\GdprExtensionsComSfc\Domain\Repository\GdprManagerRepository $gdprManagerRepository)
    {
